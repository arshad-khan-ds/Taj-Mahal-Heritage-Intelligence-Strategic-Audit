...
st.image("https://images.unsplash.com/photo-1564507592333-c60657eea523?auto=format&fit=crop&w=1200&q=80", use_column_width=True)
...
try:
        ...
        with col_chart8:
            if not filtered_df.empty:
                ...
                if y_compare:
                    ...
                    st.plotly_chart(fig8, use_column_width=True)
    ...
    st.dataframe(display_df.sort_values('Year', ascending=False))
